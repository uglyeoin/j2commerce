...
if (!empty($groupByFieldset)) {
    ...
    // J2Commerce: filter out hidden fields so they don't create empty <th> columns
    $visibleFields = array_filter($fields, fn($f) => $f->type !== 'Hidden' && !$f->hidden);
    $th_width = count($visibleFields) > 0 ? 92 / count($visibleFields) : 92;

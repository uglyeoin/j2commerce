...
<form action="<?php echo Route::_('index.php?option=com_j2commerce&view=orderstatuses'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table itemList" id="orderstatusesList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_J2COMMERCE_ORDERSTATUSES'); ?>,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_J2COMMERCE_HEADING_ORDERSTATUS_NAME', 'a.orderstatus_name', $listDirn, $listOrder); ?>
                                </th>
                                <th scope="col" class="w-10 d-none d-md-table-cell">
                                    <?php echo Text::_('COM_J2COMMERCE_HEADING_ORDERSTATUS_BADGE'); ?>
                                </th>
                                <th scope="col" class="w-15 d-none d-md-table-cell">
                                    <?php echo Text::_('COM_J2COMMERCE_HEADING_ORDERSTATUS_CSSCLASS'); ?>
                                </th>
                        ...
                        <?php foreach ($this->items as $i => $item) : ?>
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <td class="d-none d-md-table-cell">
                                    <?php echo $this->escape($item->orderstatus_cssclass); ?>
                                </td>

...
$style = '#paymentMethodList .j2commerce-payment-image {width: 140px;}';
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_j2commerce&task=paymentmethods.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_j2commerce&view=paymentmethods'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table align-middle" id="paymentMethodList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_J2COMMERCE_PAYMENT_METHODS_TABLE_CAPTION'); ?>,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_J2COMMERCE_PAYMENT_METHOD_NAME', 'a.name', $listDirn, $listOrder); ?>
                                </th>
                                <th scope="col" style="width:10%" class="d-none d-md-table-cell">
                                    <?php echo Text::_('COM_J2COMMERCE_PAYMENT_METHOD_VERSION'); ?>
                                </th>
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            // Check for payment method image
                            ...
                            $link = Route::_('index.php?option=com_plugins&task=plugin.edit&extension_id=' . $item->extension_id.'&return=' . $encodedReturn);
                            Factory::getApplication()->getLanguage()->load('plg_j2commerce_' . $item->element, JPATH_ADMINISTRATOR);
                            ?>

...
/** @var \J2Commerce\Component\J2commerce\Administrator\View\Manufacturer\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_j2commerce&layout=edit&id=' . (int) $this->item->j2commerce_manufacturer_id); ?>" method="post" name="adminForm" id="manufacturer-form" class="form-validate">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <fieldset id="fieldset-additional" class="options-form">
                            <legend><?php echo Text::_('COM_J2COMMERCE_FIELDSET_ADDITIONAL_INFORMATION'); ?></legend>
                            <div class="form-grid">
                                <?php echo $this->form->renderField('brand_desc_id'); ?>
                            </div>
                        </fieldset>
                    </div>
                </div>
    ...
    <?php echo $this->form->renderField('j2commerce_manufacturer_id'); ?>
...
<script>
/**
 * J2Commerce Manufacturer - Country/Zone AJAX linking
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadZones(countryId, selectedZoneId = 0) {
        ...
        try {
            const url = 'index.php?option=com_j2commerce&task=manufacturer.getZones&country_id=' + countryId + '&zone_id=' + selectedZoneId;

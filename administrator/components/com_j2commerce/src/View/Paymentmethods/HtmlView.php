...
namespace J2Commerce\Component\J2commerce\Administrator\View\Paymentmethods;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->paymentCards = $this->getPaymentCards();
    ...
    /**
     * Get payment cards configuration
     *
     * @return string
     */
    protected function getPaymentCards(): string
    {
        $displayData = [];

        return LayoutHelper::render('payment.default', $displayData, JPATH_COMPONENT_ADMINISTRATOR . '/layouts');
    }
    ...
    protected function addToolbar()
    {
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            $childBar->publish('paymentmethods.publish')->listCheck(true);
            $childBar->unpublish('paymentmethods.unpublish')->listCheck(true);
            $childBar->checkin('paymentmethods.checkin')->listCheck(true);
        }

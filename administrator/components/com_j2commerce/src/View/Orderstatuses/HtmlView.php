...
namespace J2Commerce\Component\J2commerce\Administrator\View\Orderstatuses;
...
/**
 * Order Statuses list view class.
 *
 * @since  6.0.7
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_J2COMMERCE_ORDERSTATUSES'), 'fas fa-solid fa-check-square');
        ...
        if ($canDo->get('core.delete') && ($this->state->get('filter.enabled') == -2)) {
            $toolbar->delete('orderstatuses.delete', 'JTOOLBAR_DELETE_FROM_TRASH')->listCheck(true);
        }

...
/**
 * Taxrules list controller class.
 *
 * @since  6.0.3
 */
class TaxrulesController extends AdminController
{
    /**
     ...
     * @since   6.0.3
     */
    public function getModel($name = 'Taxrule', $prefix = 'Administrator', $config = ['ignore_request' => true])
    {

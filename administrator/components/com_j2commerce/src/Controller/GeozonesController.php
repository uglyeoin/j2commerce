...
/**
 * Geozones list controller class.
 *
 * @since  6.0.3
 */
class GeozonesController extends AdminController
{
    /**
     ...
     * @since   6.0.3
     */
    public function getModel($name = 'Geozone', $prefix = 'Administrator', $config = ['ignore_request' => true])
    {

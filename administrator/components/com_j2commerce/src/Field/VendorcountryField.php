...
/**
 * Vendor Country field - provides a dropdown of countries that have vendors.
 *
 * Only shows countries that are linked to at least one vendor via their address.
 *
 * @since  6.0.7
 */
class VendorcountryField extends ListField
{
    ...
    public function getOptions(): array
    {
        ...
        try {
            ...
            // Get distinct countries that have vendors via their addresses

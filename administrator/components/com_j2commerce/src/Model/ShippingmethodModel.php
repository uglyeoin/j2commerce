 ...
 * @since  6.0.0
 */
class ShippingmethodModel extends AdminModel
{
    /**
     ...
     * @since  6.0.0
     */
    public $typeAlias = 'com_j2commerce.shippingmethod';
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_j2commerce.edit.shippingmethod.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_j2commerce.shippingmethod', $data);
    ...
    public function delete(&$pks)
    {
        ...
        $app->enqueueMessage(Text::_('COM_J2COMMERCE_SHIPPING_METHOD_DELETE_NOT_ALLOWED'), 'error');
        return false;
    }
}

...
class TaxrateModel extends AdminModel
{
     ...
     * @since  6.0.3
     */
    public $typeAlias = 'com_j2commerce.taxrate';
     ...
     * @since  6.0.3
     */
    protected $text_prefix = 'COM_J2COMMERCE_TAXRATE';

    /**
     * Method to auto-populate the model state.
     *
     * CRITICAL: This override is required because the parent AdminModel::populateState()
     * looks for a URL parameter named after the table's primary key (j2commerce_taxrate_id),
    ...
    {
        $form = $this->loadForm('com_j2commerce.taxrate', 'taxrate', ['control' => 'jform', 'load_data' => $loadData]);
     ...
     * @since   6.0.3
     */
    public function getTable($name = 'Taxrate', $prefix = 'Administrator', $options = []): Table
    {
    ...
    {
        $app  = Factory::getApplication();
        $data = $app->getUserState('com_j2commerce.edit.taxrate.data', []);

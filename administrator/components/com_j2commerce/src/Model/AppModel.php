...
class AppModel extends AdminModel
{
     ...
     * @since  6.0.0
     */
    public $typeAlias = 'com_j2commerce.app';
     ...
     * @since  6.0.0
     */
    protected $text_prefix = 'COM_J2COMMERCE_APP';
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_j2commerce.edit.App.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_j2commerce.App', $data);
    ...
    public function delete(&$pks)
    {
        ...
        $app->enqueueMessage(Text::_('COM_J2COMMERCE_APP_DELETE_NOT_ALLOWED'), 'error');
        return false;
    }
}

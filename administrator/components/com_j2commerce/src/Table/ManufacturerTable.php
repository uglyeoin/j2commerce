...
class ManufacturerTable extends Table
{
    ...
    {
        // IMPORTANT: The primary key here ('j2commerce_manufacturer_id') MUST match
    ...
    public function check(): bool
    {
        ...
        // Set default brand_desc_id for new records
        if (!isset($this->brand_desc_id) || $this->brand_desc_id === '') {
            $this->brand_desc_id = 0;
        }
    ...
    public function store($updateNulls = true): bool
    {
        ...
        if (empty($this->j2commerce_manufacturer_id)) {

...
$counter  = 0;
?>
<div class="j2commerce-crosssells-container mt-5 pt-4 border-top">
    <h3 class="text-center mb-5"><?php echo Text::_('COM_J2COMMERCE_RELATED_PRODUCTS_CROSS_SELLS'); ?></h3>
    ...
    <?php foreach ($crossSells as $product) : ?>
        ...
        if ($rowcount === 1) :
            ...
            ?>
            <div class="j2commerce-crosssells-row row-<?php echo $row; ?> row g-4 mb-4">
        <?php endif; ?>

...
<form action="<?php echo Route::_('index.php?option=com_j2commerce&view=checkout'); ?>"
    ...
    <div class="j2commerce-payment-cash note note-<?php echo htmlspecialchars($vars->orderpayment_type, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <input type="hidden" name="order_id" value="<?php echo htmlspecialchars((string) $vars->order_id, ENT_QUOTES, 'UTF-8'); ?>" />

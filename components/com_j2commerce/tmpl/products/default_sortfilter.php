...
// Use the current SEF URL path as the form action
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Skip fallback handlers if J2CommerceFilters AJAX class will handle them
    ...
    if (ajaxEnabled && typeof J2CommerceFilters !== 'undefined') {
        return; // Let J2CommerceFilters handle all filter interactions
    }
